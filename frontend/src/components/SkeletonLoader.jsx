...
export default function SkeletonLoader({ type = 'card' }) {
  if (type === 'timeline') {
    return (
      <div className="space-y-4 animate-pulse">
        {[1, 2, 3].map((i) => (
          <div key={i} className="flex items-center space-x-3 bg-white/70 p-3.5 border border-slate-300">
  ...
  if (type === 'verdict') {
    return (
      <div className="space-y-6 animate-pulse">
        <div className="h-40 bg-white/70 border border-slate-300" />
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="h-48 bg-white/70 border border-slate-300" />
          <div className="h-48 bg-white/70 border border-slate-300" />
        </div>
      </div>
    );
  ...
  return (
    <div className="bg-white/80 p-6 border border-slate-300 shadow-sm space-y-4 animate-pulse">
