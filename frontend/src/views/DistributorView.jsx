...
import { Truck, Search, CheckCircle2, RefreshCw } from 'lucide-react';
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-600 mt-0.5 max-w-2xl leading-relaxed">
              Inspect incoming batch shipments, record warehouse receipt, and transfer custody to accredited pharmacy networks.
            </p>
          </div>
        </div>
      </div>
