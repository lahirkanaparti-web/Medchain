    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-slate-100/70 rounded p-5 sm:p-6 border border-slate-300 space-y-1">
        ...
        <p className="text-xs text-slate-600 max-w-2xl leading-relaxed">
          Inspect incoming batch shipments, perform physical defect inspection, and record GPS-tagged warehouse receipt or dispatch handoffs.
        </p>
      </div>
      ...
      {!loading && !batch && (
        <div className="bg-white rounded p-8 border border-slate-300 text-center space-y-2 doc-panel">
          ...
          <p className="font-display font-semibold text-sm text-pharma-deep">
            No batch selected for logistics handoff
          </p>
          <p className="text-xs text-slate-500 max-w-md mx-auto">
            Enter a batch serial number above to inspect origin records and confirm warehouse receipt or transit dispatch.
          </p>
        </div>
      )}
            ...
            {(batch.isRecalled || batch.state === 5) && (
              <div className="bg-quarantine-crimson text-white p-5 rounded doc-panel space-y-2 shadow-sm">
                ...
                <p className="text-xs text-white/90 leading-relaxed">
                  This batch was automatically recalled on-chain following physical defect detection and multi-step investigation. All further custody transfers are permanently blocked.
                </p>
                {batch.recallReason && (
              ...
              <div className="space-y-3 pt-3 border-t border-slate-200">
                <div className="flex items-center justify-between">
                  <h4 className="text-xs font-semibold text-slate-700">
                    Custody handoff actions (GPS location-enabled)
                  </h4>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  ...
                  >
                    {actionLoading ? (
                      ...
                      <span>Confirm dispatch: In transit (1)</span>
                    )}
                  </button>
                  ...
                  >
                    {actionLoading ? (
                      ...
                      <>
                        ...
                        <span>Confirm receipt: At distributor (2)</span>
                      </>
                    )}
                  </button>
                </div>
